...
%         fileName = ['reanalysis_TS07Dmid15_final_q=500r_newDxx_RUN6/Reanalysis_EQE_LatestVERB_noMP_201210_Gaussian_onera_TS07Dmid15.mat'];
        fileName = ['/export/dmsrbm/jscv/Reanalysis_Cervantes_etal2_2020_01Oct2012-01Oct2016/Reanalysis files_Chorus2014Hiss2014/reanalysis_full_run_3D+MT+EMICS+MP_Chorus2014Hiss2014/Reanalysis_',yrmo,'.mat'];
        data = load(fileName);
        PSD_obs = data.PSD_obs;
