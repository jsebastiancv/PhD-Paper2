            ...
            try
                ...
                spc_InvMu = [];
                 while cdate < ed
                    ...
                    if strcmp(instr,'MAGEDandEPEAD'); file = [sdir,spc,'_',instr,'_',dates,'_psd_',hptxt,mfmtxt,'_ver4_calibrated.mat']; end
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_psd_n4_4_',hptxt,mfmtxt,'_ver4_calibrated.mat']; end
                    if strcmp(instr,'rept'); file = [sdir,spc,'_',instr,'_',dates,'_psd_',hptxt,mfmtxt,'_ver4_calibrated.mat']; end
                    if load_errors_from_file
                        try
                            load(file);
                    ...
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_lstar_n4_4_',hptxt,mfmtxt,'_ver4.mat']; end
                    ...
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_invmu_and_invk_n4_4_',hptxt,mfmtxt,'_ver4.mat']; end
...
%         end        
        ...
        if Pdyn_sim > 3 
             if min_mp < 6.6
                 mat_file = ['Model Matrices/Debug_ZeroVal_EMICs/Kp=',num2str(Kp_sim),'.mat'];
             else
                mat_file = ['Model Matrices/Debug_ZeroDer_EMICs/Kp=',num2str(Kp_sim),'.mat'];
             end
        else
             if min_mp < 6.6
                 mat_file = ['Model Matrices/Debug_ZeroVal_NoEMICs/Kp=',num2str(Kp_sim),'.mat'];
             else
                mat_file = ['Model Matrices/Debug_ZeroDer_NoEMICs/Kp=',num2str(Kp_sim),'.mat'];
             end
        end
