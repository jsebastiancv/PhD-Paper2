    ...
    if ~model_simulation_only
            ...
            try
                ...
                spc_InvMu = [];
                 while cdate < ed
                    ...
                    if strcmp(instr,'MAGEDandEPEAD'); file = [sdir,spc,'_',instr,'_',dates,'_psd_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_psd_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'rept'); file = [sdir,spc,'_',instr,'_',dates,'_psd_',hptxt,mfmtxt,'_ver3.mat']; end
                    if load_errors_from_file
                        try
                            load(file);
                    ...
                    if strcmp(instr,'MAGEDandEPEAD'); file = [sdir,spc,'_',instr,'_',dates,'_lstar_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_lstar_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'rept'); file = [sdir,spc,'_',instr,'_',dates,'_lstar_',hptxt,mfmtxt,'_ver3.mat']; end                    
                    load(file);
                    
                    if strcmp(instr,'MAGEDandEPEAD'); file = [sdir,spc,'_',instr,'_',dates,'_invmu_and_invk_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'mageis'); file = [sdir,spc,'_',instr,'_',dates,'_invmu_and_invk_',hptxt,mfmtxt,'_ver3.mat']; end
                    if strcmp(instr,'rept'); file = [sdir,spc,'_',instr,'_',dates,'_invmu_and_invk_',hptxt,mfmtxt,'_ver3.mat']; end                           
                    load(file);

                    if strcmp(instr,'MAGEDandEPEAD')
                        file = [sdir,spc,'_',instr,'_',dates,'_alpha_and_energy_',hptxt,mfmtxt,'_ver3.mat']; 
                        load(file)
        ...
        %                errPSD = errPSD(:,ok_ech,:);
                    elseif strcmp(instr,'mageis')
                        file = [sdir,spc,'_',instr,'_',dates,'_alpha_and_energy_',hptxt,mfmtxt,'_ver3.mat']; load(file);
...
%     save(output_file_name,'SimTime','Kp','SimInvMu','SimInvK','SimInvEnergy','SimInvAlpha','SimL','Pa_alpha','Pa_pc','Pa_L','PSD_obs');
